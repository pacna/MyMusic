...
export const SongDetail = (props: SongDetailConfig): JSX.Element => {
    ...
    const toggleSoundWave = useSelector(
        (state: RootStateOrAny) => state.toggleSoundWave.value
    );
    ...
    return (
        <div>
            ...
            >
                <MenuItem
                    onClick={() => handleEditMenu(song.id)}
                    divider={true}
                ...
                <MenuItem
                    onClick={() => handleDeleteMenu(song.id)}
